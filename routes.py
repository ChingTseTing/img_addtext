...
def handle_image(event):
  ...
  img_url = f'https://line-bot-python-flask-b50t.onrender.com/result/{file_name}' #img_getlink(  local_save)#f'https://{os.getenv("YOUR_HEROKU_APP_NAME")}.herokuapp.com/result/{file_name}'
